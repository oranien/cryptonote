...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xd0;
...
const char     CRYPTONOTE_NAME[]                             = "moos";
...
const int      P2P_DEFAULT_PORT                              = 19851;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 19852;
